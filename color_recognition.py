...
COLOR_DICT = {
    ...
    'green': {'lower': np.array([36, 50, 70]), 'upper': np.array([77, 255, 255])},
...
class XArmCtrl(object):
    ...
    def _init(self):
        self._commander.set_max_acceleration_scaling_factor(0.3)
        self._commander.set_max_velocity_scaling_factor(0.3)
...
def get_recognition_rect(frame, lower=COLOR_DICT['blue']['lower'], upper=COLOR_DICT['blue']['upper'], show=True):
